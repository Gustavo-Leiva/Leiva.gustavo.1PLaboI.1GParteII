 ...
 * \param mensaje[] char mensaje texto que indica cual es el dato solicitado
 * \param minimo int int minimo a respetar
 * \param maximo int int maximo a respetar
 * \return int retorna 1 si pudo pedir y validar la informacion que ingreso el usuario
 *
 */
